...
Utility function for calculating the file-face attributes to pass to defface."
  (labels ((alist->plist (alist)
    ...
    (append (alist->plist (face-all-attributes 'org-brain-file-face (selected-frame))) `(:inherit ,face))))

;; ** Faces
(defface org-brain-file-face-attrs
  '((t . (:slant italic)))
...
(defface org-brain-title-file
  ;; `((t . ,(append (alist->plist (face-all-attributes 'org-brain-file-face)) '(:inherit org-brain-title)))))
  ;; `((t . ,(append (alist->plist (face-all-attributes 'org-brain-file-face (selected-frame))) '(:inherit 'org-brain-title))))
...
(defun org-brain-display-face (entry &optional face)
  "Return the final display face for ENTRY, based on FACE."
